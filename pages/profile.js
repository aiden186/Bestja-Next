  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>Profile - Bestja</title>
          <meta
            name="description"
            content="Bestja, il-logÄ§ba tal-karti fuq il-monstri tal-folklore Malti."
          />
          <meta property="og:title" content="Profile - Bestja" />
          <meta
        ...
        <div className="profile">
          ...
          <div className="container01">
            <div className="container02">
              <h4 className="text">Michael Roven</h4>
              <OutlineBlueButton button="follow"></OutlineBlueButton>
            </div>
            <div className="container03">
              <span className="text01">
                <span className="text02">323</span>
                <span> Posts</span>
              </span>
              <span className="text04">
                <span className="text05">3.5k</span>
                <span> Followers</span>
              </span>
              <span>
                <span className="text08">260</span>
                <span> Following</span>
              </span>
            </div>
        ...
        <div className="blog-posts">
          <h1 className="text11 headingTwo">
            <span></span>
            ...
            <div className="container05">
              <div className="card">
                <div className="container06">
                  <h1 className="text14">Flexible work hours</h1>
                  ...
                  <div className="container07">
                    <button className="button">
                      <span className="text17">Read more</span>
        ...
        <div className="contact">
          <div className="container09">
            <div className="form">
              <h2 className="text18 headingOne">
                <span>Say Hi!</span>
              </h2>
              <span className="text20 lead">
                We&apos;d like to talk with you.
              </span>
              <form className="form1">
                <label className="text21 label">My name is</label>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="textinput small input"
                />
                <label className="text22 label">I&apos;m looking for</label>
                <input
                  type="text"
                  placeholder="What you love"
                  className="textinput1 small input"
                />
                <label className="text23 label">Your message</label>
                <textarea
                  rows="8"
              ...
              <div className="container12">
                ...
                <div className="container13">
                  <div className="container14">
                    ...
                    <a href="tel:+40 772 100 200" className="link small">
                      (+40) 772 100 200
                    </a>
                  </div>
                ...
                <div className="container17">
                  ...
                  <svg viewBox="0 0 877.7142857142857 1024" className="icon14">
